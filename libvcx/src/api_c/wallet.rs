...
use crate::api_vcx::api_global::wallet::open_as_main_wallet;
...
pub mod tests {
    ...
    use aries_vcx::global::settings::{
        CONFIG_EXPORTED_WALLET_PATH, CONFIG_WALLET_BACKUP_KEY, CONFIG_WALLET_KEY, CONFIG_WALLET_KEY_DERIVATION,
        CONFIG_WALLET_NAME, DEFAULT_WALLET_KEY, DEFAULT_WALLET_NAME, WALLET_KDF_RAW,
    };
    ...
    use crate::api_c::vcx::test_utils::{_test_add_and_get_wallet_record, _vcx_create_and_open_wallet};
    use crate::api_vcx::api_global::settings;
    use crate::api_vcx::api_global::settings::get_config_value;
    use crate::api_vcx::api_global::wallet::{close_main_wallet, create_and_open_as_main_wallet};
    use crate::errors::error;
    ...
    async fn test_wallet_export_import() {
        ...
        let import_config = json!({
            CONFIG_WALLET_NAME: wallet_config.wallet_name.clone(),
            CONFIG_WALLET_KEY: wallet_config.wallet_key.clone(),
            CONFIG_EXPORTED_WALLET_PATH: export_file.path,
            CONFIG_WALLET_KEY_DERIVATION: WALLET_KDF_RAW,
            CONFIG_WALLET_BACKUP_KEY: backup_key,
        })
        .to_string();
