...
pub extern "C" fn vcx_revocation_registry_create(
    ...
    check_useful_c_str!(rev_reg_config, ErrorKindLibvcx::InvalidOption);
...
pub extern "C" fn vcx_revocation_registry_publish(
    ...
    check_useful_c_callback!(cb, ErrorKindLibvcx::InvalidOption);
    check_useful_c_str!(tails_url, ErrorKindLibvcx::InvalidOption);
...
pub extern "C" fn vcx_revocation_registry_deserialize(
    ...
    check_useful_c_callback!(cb, ErrorKindLibvcx::InvalidOption);
    check_useful_c_str!(rev_reg_json, ErrorKindLibvcx::InvalidOption);
