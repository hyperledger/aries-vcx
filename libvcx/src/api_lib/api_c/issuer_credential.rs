    ...
    execute(move || {
        match issuer_credential::get_credential_offer_msg(credential_handle) {
            Ok(offer_msg) => {
                ...
                cb(command_handle, error_libvcx::SUCCESS_ERR_CODE, offer_msg.as_ptr());
            }
            Err(err) => {
                set_current_error_vcx(&err);
    ...
    execute(move || {
        match issuer_credential::get_rev_reg_id(credential_handle) {
            Ok(rev_reg_id) => {
                ...
                cb(command_handle, error_libvcx::SUCCESS_ERR_CODE, rev_reg_id.as_ptr());
            }
            Err(err) => {
                set_current_error_vcx(&err);
    ...
    execute(move || {
        match issuer_credential::is_revokable(credential_handle) {
            Ok(revokable) => {
                ...
                cb(command_handle, error_libvcx::SUCCESS_ERR_CODE, revokable);
            }
            Err(err) => {
                set_current_error_vcx(&err);
    ...
    execute(move || {
        match issuer_credential::get_thread_id(credential_handle) {
            Ok(s) => {
                ...
                cb(command_handle, error_libvcx::SUCCESS_ERR_CODE, thread_id.as_ptr());
            }
            Err(err) => {
                error!(
                    "vcx_issuer_credential_get_thread_id_cb(commmand_handle: {}, rc: {}, thread_id: {}) source_id: {}",
...
pub mod tests {
    ...
    fn test_vcx_issuer_credential_release() {
        ...
        assert_eq!(vcx_issuer_credential_release(handle), error_libvcx::SUCCESS_ERR_CODE);
