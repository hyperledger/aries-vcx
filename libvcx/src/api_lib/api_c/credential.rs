...
pub extern "C" fn vcx_credential_create_with_offer(
    ...
    check_useful_c_str!(offer, ErrorKindLibvcx::InvalidOption);
...
pub extern "C" fn vcx_credential_create_with_msgid(
    ...
    check_useful_c_callback!(cb, ErrorKindLibvcx::InvalidOption);
    check_useful_c_str!(source_id, ErrorKindLibvcx::InvalidOption);
    check_useful_c_str!(msg_id, ErrorKindLibvcx::InvalidOption);
    ...
    execute_async::<BoxFuture<'static, Result<(), ()>>>(Box::pin(async move {
        match credential::credential_create_with_msgid(&source_id, connection_handle, &msg_id).await {
            Ok((handle, offer_string)) => {
                ...
                trace!("vcx_credential_create_with_offer_cb(command_handle: {}, source_id: {}, rc: {}, handle: {}) source_id: {}", command_handle, source_id, error::SUCCESS_ERR_CODE, handle, source_id);
...
pub extern "C" fn vcx_credential_get_request_msg(
    ...
    check_useful_c_str!(my_pw_did, ErrorKindLibvcx::InvalidOption);
    check_useful_opt_c_str!(their_pw_did, ErrorKindLibvcx::InvalidOption);
    check_useful_c_callback!(cb, ErrorKindLibvcx::InvalidOption);
...
mod tests {
    ...
    fn test_vcx_credential_create_with_offer_fails() {
        ...
        assert_eq!(err, u32::from(ErrorKindLibvcx::InvalidJson));
    }
    ...
    fn test_vcx_credential_release() {
        ...
        assert_eq!(
            ...
            u32::from(ErrorKindLibvcx::InvalidCredentialHandle)
        );
