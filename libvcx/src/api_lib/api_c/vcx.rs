...
mod tests {
    ...
    fn test_shutdown() {
        ...
        let credentialdef = credential_def::create_and_publish_credentialdef("SID".to_string(), "4fUDR9R7fjwELRvH9JT6HH".to_string(), "id".to_string(), "tag".to_string(), "{}".to_string()).unwrap();
