...
pub mod tests {
    ...
    mod aries {
        ...
        fn test_connection_send_works() {
            ...
            let _res = ::agency_vcx::get_message::download_messages_noauth(None, None, Some(vec![uid.clone()])).unwrap();
            ...
            {
                use agency_vcx::get_message::{download_messages_noauth, MessageByConnection, Message};
