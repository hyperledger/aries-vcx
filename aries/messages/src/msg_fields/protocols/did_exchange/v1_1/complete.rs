...
/// of this message type is not recommended, as it will be indistinguisable from V1.0.
...
mod tests {
    ...
    fn test_minimal_complete_message() {
        ...
        test_utils::test_constructed_msg(msg, DidExchangeTypeV1_1::Complete, expected);
    }
