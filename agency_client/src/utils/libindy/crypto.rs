...
pub async fn pack_message(sender_vk: Option<&str>, receiver_keys: &str, msg: &[u8]) -> AgencyClientResult<Vec<u8>> {
...
pub async fn unpack_message(msg: &[u8]) -> AgencyClientResult<Vec<u8>> {
    if agency_mocks_enabled() {
