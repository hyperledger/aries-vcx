...
//     ddo_builder: DidDocumentBuilder,
//     services: Vec<ServiceSov>,
// }
//
...
//         S: serde::Serializer,
//     {
//         let mut builder: DidDocumentBuilder = self.did_doc.clone().into();
//
...
// }
//
// impl From<DidDocumentSov> for DidDocument {
//     fn from(ddo: DidDocumentSov) -> Self {
//         let mut ddo_builder = DidDocument::builder(ddo.did_doc.id().clone());
...
// }
//
// impl From<DidDocument> for DidDocumentSov {
//     fn from(ddo: DidDocument) -> Self {
