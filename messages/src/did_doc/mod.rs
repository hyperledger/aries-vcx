...
impl DidDoc {
    ...
    pub fn get_service(&self) -> MessagesResult<AriesService> {
        let service: &AriesService = self.service.get(0).ok_or(ErrorMessages::from_msg(
            ErrorKindMessages::InvalidState,
