...
#[serde(transparent)]
pub struct NotificationProblemReportContent {
    pub inner: ProblemReportContent,
}

impl From<ProblemReportContent> for NotificationProblemReportContent {
    fn from(value: ProblemReportContent) -> Self {
        Self { inner: value }
    }
}

impl From<NotificationProblemReport> for ProblemReport {
    fn from(value: NotificationProblemReport) -> Self {
        Self::builder()
            .id(value.id)
