...
%define _rpmdir /home/mspence/Evernym/vdr-tools/libindy/rpms
...
cp -a /home/mspence/Evernym/vdr-tools/libindy/include/*.h $RPM_BUILD_ROOT/%{_includedir}/indy/
install -Dm0644 /home/mspence/Evernym/vdr-tools/libindy/target/release/libindy.a $RPM_BUILD_ROOT/%{_libdir}/libindy.a
install -Dm0644 /home/mspence/Evernym/vdr-tools/libindy/target/release/libindy.so $RPM_BUILD_ROOT/%{_libdir}/libindy.so
