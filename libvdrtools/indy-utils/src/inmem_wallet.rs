...
impl InmemWallet {
    ...
    pub extern "C" fn open(
        ...
        handles.insert(xhandle, InmemWalletContext { id });
    ...
    pub extern "C" fn add_record(
        ...
        wallet.records.insert(
            InmemWallet::build_record_id(&type_, &id),
            InmemWalletRecord {
    ...
    pub extern "C" fn update_record_value(
        xhandle: i32,
        type_: *const c_char,
        id: *const c_char,
        joined_value: *const u8,
        joined_value_len: usize,
    ) -> ErrorCode {
        check_useful_c_str!(type_, ErrorCode::CommonInvalidStructure);
        check_useful_c_str!(id, ErrorCode::CommonInvalidStructure);
        check_useful_c_byte_array!(
        ...
        match wallet
            .records
            .get_mut(&InmemWallet::build_record_id(&type_, &id))
        {
    ...
    pub extern "C" fn get_record_id(
        xhandle: i32,
        record_handle: i32,
        id_ptr: *mut *const c_char,
    ) -> ErrorCode {
        let handles = INMEM_OPEN_WALLETS.lock().unwrap();
    ...
    pub extern "C" fn get_record_type(
        xhandle: i32,
        record_handle: i32,
        type_ptr: *mut *const c_char,
    ) -> ErrorCode {
        let handles = INMEM_OPEN_WALLETS.lock().unwrap();
    ...
    pub extern "C" fn get_record_value(
        xhandle: i32,
        record_handle: i32,
    ...
    pub extern "C" fn get_record_tags(
        xhandle: i32,
        record_handle: i32,
        tags_json_ptr: *mut *const c_char,
    ) -> ErrorCode {
        let handles = INMEM_OPEN_WALLETS.lock().unwrap();
    ...
    pub extern "C" fn add_record_tags(
        xhandle: i32,
        type_: *const c_char,
        id: *const c_char,
        tags_json: *const c_char,
            ...
            .get_mut(&InmemWallet::build_record_id(&type_, &id))
        {
            Some(ref mut record) => {
                ...
                let curr_tags_result =
                    serde_json::from_str::<HashMap<String, String>>(&curr_tags_json);
    ...
    pub extern "C" fn update_record_tags(
        xhandle: i32,
        type_: *const c_char,
        id: *const c_char,
        tags_json: *const c_char,
    ...
    pub extern "C" fn delete_record_tags(
        xhandle: i32,
        type_: *const c_char,
        id: *const c_char,
        tag_names: *const c_char,
    ) -> ErrorCode {
        check_useful_c_str!(type_, ErrorCode::CommonInvalidStructure);
        check_useful_c_str!(id, ErrorCode::CommonInvalidStructure);
    ...
    pub extern "C" fn get_storage_metadata(
        xhandle: i32,
        metadata_ptr: *mut *const c_char,
    ...
    pub extern "C" fn search_records(
        xhandle: i32,
        type_: *const c_char,
    ...
    pub extern "C" fn get_search_total_count(
        xhandle: i32,
        search_handle: i32,
        count: *mut usize,
    ) -> ErrorCode {
    ...
    pub extern "C" fn fetch_search_next_record(
        xhandle: i32,
        search_handle: i32,
        record_handle: *mut i32,
    ) -> ErrorCode {
        let handles = INMEM_OPEN_WALLETS.lock().unwrap();
        ...
        match searches.get_mut(&search_handle) {
            Some(records) => match records.pop() {
                Some(record) => {
                    let handle = sequence::get_next_id();
    ...
    pub extern "C" fn delete(name: *const c_char, _: *const c_char, _: *const c_char) -> ErrorCode {
