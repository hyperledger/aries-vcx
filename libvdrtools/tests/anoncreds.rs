...
mod high_cases {
    ...
    mod issuer_create_schema {
        ...
        fn issuer_create_schema_works() {
            let (schema_id, _) = anoncreds::issuer_create_schema(
                ISSUER_DID,
                GVT_SCHEMA_NAME,
                SCHEMA_VERSION,
        ...
        fn issuer_create_schema_works_for_fully_qualified_did() {
            ...
            .unwrap();
            assert_eq!(
                SchemaId(anoncreds::gvt_schema_id_fully_qualified()).0,
                schema_id
            );
        }
    }
    ...
    mod prover_get_credentials {
        ...
        fn prover_get_credentials_works_for_empty_filter() {
            ...
            let wallet_handle =
                wallet::open_wallet(ANONCREDS_WALLET_CONFIG, WALLET_CREDENTIALS).unwrap();
        ...
        fn prover_get_credentials_works_for_filter_by_issuer_did() {
            ...
            let credentials =
                anoncreds::prover_get_credentials(wallet_handle, &filter_json).unwrap();
            let credentials: Vec<CredentialInfo> = serde_json::from_str(&credentials).unwrap();
        ...
        fn prover_get_credentials_works_for_filter_by_schema_name() {
            ...
            let credentials = anoncreds::prover_get_credentials(
                wallet_handle,
                &format!(r#"{{"schema_name":"{}"}}"#, GVT_SCHEMA_NAME),
            )
            .unwrap();
            let credentials: Vec<CredentialInfo> = serde_json::from_str(&credentials).unwrap();
        ...
        fn prover_get_credentials_works_for_filter_by_schema_issuer_did() {
            ...
            let credentials = anoncreds::prover_get_credentials(
                wallet_handle,
                &format!(r#"{{"schema_issuer_did":"{}"}}"#, ISSUER_DID),
            )
            .unwrap();
            let credentials: Vec<CredentialInfo> = serde_json::from_str(&credentials).unwrap();
        ...
        fn prover_get_credentials_works_for_filter_by_cred_def_id() {
            ...
            let filter =
                json!({ "cred_def_id": anoncreds::issuer_1_gvt_cred_def_id() }).to_string();
        ...
        fn prover_get_credentials_works_for_empty_result() {
            ...
            let credentials = anoncreds::prover_get_credentials(
                wallet_handle,
                r#"{"cred_def_id":"other_cred_def_id"}"#,
            )
            .unwrap();
            let credentials: Vec<CredentialInfo> = serde_json::from_str(&credentials).unwrap();
    ...
    mod prover_get_credential {
        ...
        fn prover_get_credential_works() {
            ...
            let credential =
                anoncreds::prover_get_credential(wallet_handle, CREDENTIAL1_ID).unwrap();
    ...
    mod prover_credentials_search {
        ...
        fn credentials_search_works() {
            ...
            let (search_handle, count) =
                anoncreds::prover_search_credentials(wallet_handle, "{}").unwrap();
            assert_eq!(count, 4);
        ...
        fn credentials_search_works_for_filter_by_issuer_did() {
            ...
            let filter_json = json!({ "issuer_did": ISSUER_DID }).to_string();
            let (search_handle, count) =
                anoncreds::prover_search_credentials(wallet_handle, &filter_json).unwrap();
            assert_eq!(count, 2);
    ...
    mod prover_get_credentials_for_proof_req {
        ...
        use utils::domain::anoncreds::{
            credential_definition::CredentialDefinitionId, schema::SchemaId,
        };
        ...
        fn prover_get_credentials_for_proof_req_works_for_revealed_attr_only() {
            ...
            let credentials_json =
                anoncreds::prover_get_credentials_for_proof_req(wallet_handle, &proof_req).unwrap();
        ...
        fn prover_get_credentials_for_proof_req_works_for_predicate() {
            ...
            let credentials_for_predicate_1 =
        ...
        fn prover_get_credentials_for_proof_req_works_for_multiple_revealed_attrs_and_predicates() {
            ...
            let credentials_for_predicate_2 =
                credentials.predicates.get("predicate2_referent").unwrap();
    ...
    mod prover_search_credentials_for_proof_req {
        ...
        fn prover_search_credentials_for_proof_req_works_for_revealed_attr_only() {
            ...
            let search_handle =
                anoncreds::prover_search_credentials_for_proof_req(wallet_handle, &proof_req, None)
                    .unwrap();
            ...
            let credentials: Vec<RequestedCredential> =
                serde_json::from_str(&credentials_json).unwrap();
        ...
        mod validation {
            ...
            fn prover_search_credentials_for_proof_req_works_for_proof_req_v1_contains_fully_qualified_restrictions(
                ...
                let res = anoncreds::prover_search_credentials_for_proof_req(
                    wallet_handle,
                    &proof_req,
                    None,
                );
    ...
    mod prover_create_proof_works {
        ...
        fn prover_create_proof_works_for_using_not_satisfy_credential() {
            ...
            let res = anoncreds::prover_create_proof(
                wallet_handle,
                &proof_req,
                &requested_credentials_json,
                COMMON_MASTER_SECRET,
    ...
    mod verifier_verify_proof {
        ...
        fn verifier_verify_proof_works_for_wrong_revealed_attr_value() {
            let proof_json = anoncreds::proof_json().replace(
                r#"name":"1139481716457488690172217916278103335"#,
                r#"name":"1111111111111111111111111111111111111"#,
            );
        ...
        fn verifier_verify_proof_works_for_wrong_encoded() {
            let proof_json = anoncreds::proof_json().replace(
                r#"encoded":"1139481716457488690172217916278103335"#,
                r#"encoded":"1111111111111111111111111111111111111"#,
            );
        ...
        fn verifier_verify_proof_works_for_revealed_attr_case_insensitive() {
            let proof_req_json =
                anoncreds::proof_request_attr().replace(r#""name":"name""#, r#""name":"NAME""#);
    ...
    mod verifier_verify_proof_with_proof_req_restrictions {
        ...
        fn verifier_verify_proof_successful() {
            let valid = anoncreds::verifier_verify_proof(
                &anoncreds::proof_request_restrictions(),
    ...
    mod issuer_rotate_credential_def {
        ...
        fn issuer_rotate_credential_def_works() {
            ...
            let temp_cred_def_json = anoncreds::issuer_rotate_credential_def_start(
                setup.wallet_handle,
                &cred_def_id,
                None,
            )
            ...
            anoncreds::issuer_rotate_credential_def_apply(setup.wallet_handle, &cred_def_id)
                .unwrap();
        }
        ...
        fn issuer_rotate_credential_def_works_no_cred_def() {
            ...
            let res = anoncreds::issuer_rotate_credential_def_start(
                setup.wallet_handle,
        ...
        fn issuer_rotate_credential_def_apply_works_for_no_temporary_cred_def() {
            ...
            let res = anoncreds::issuer_rotate_credential_def_apply(
                setup.wallet_handle,
                &anoncreds::issuer_1_gvt_cred_def_id(),
            );
    ...
    mod to_unqualified {
        ...
        fn to_unqualified_ids() {
            ...
            assert_eq!(
                ...
                anoncreds::to_unqualified(&anoncreds::gvt_schema_id_fully_qualified()).unwrap()
            );

            assert_eq!(
                anoncreds::gvt_cred_def_id(),
                anoncreds::to_unqualified(&anoncreds::gvt_cred_def_id_fully_qualified()).unwrap()
            );

            assert_eq!(
                anoncreds::local_gvt_cred_def_id(),
                anoncreds::to_unqualified(&anoncreds::local_gvt_cred_def_id_fully_qualified())
                    .unwrap()
            );
        }
        ...
        fn to_unqualified_objects() {
            ...
            assert_eq!(
                anoncreds::gvt_schema_id(),
                anoncreds::to_unqualified(&schema_id).unwrap()
            );
            ...
            anoncreds::prover_create_master_secret(setup.wallet_handle, COMMON_MASTER_SECRET)
                .unwrap();
...
mod medium_cases {
    ...
    mod issuer_create_schema {
        ...
        fn issuer_create_schema_works_for_empty_attrs() {
            let res =
                anoncreds::issuer_create_schema(ISSUER_DID, GVT_SCHEMA_NAME, SCHEMA_VERSION, "[]");
            assert_code!(ErrorCode::CommonInvalidStructure, res);
        }

        #[test]
        fn issuer_create_schema_works_for_invalid_issuer_did() {
            let res = anoncreds::issuer_create_schema(
                INVALID_BASE58_DID,
                GVT_SCHEMA_NAME,
                SCHEMA_VERSION,
                GVT_SCHEMA_ATTRIBUTES,
        ...
        fn issuer_create_schema_works_for_attrs_count_more_than_acceptable() {
            let attr_names: AttributeNames = (0..MAX_ATTRIBUTES_COUNT + 1)
                .map(|i| i.to_string())
    ...
    mod issuer_create_and_store_credential_def {
        ...
        fn issuer_create_and_store_credential_def_works_for_invalid_schema() {
            ...
            let res = anoncreds::issuer_create_credential_definition(
                wallet_handle,
                ISSUER_DID,
                &schema,
                TAG_1,
        ...
        fn issuer_create_and_store_credential_def_works_for_correct_signature_type() {
            let (wallet_handle, wallet_config) = wallet::create_and_open_default_wallet(
                "issuer_create_and_store_credential_def_works_for_correct_signature_type",
            )
            .unwrap();

            anoncreds::issuer_create_credential_definition(
                wallet_handle,
                ISSUER_DID,
                &anoncreds::gvt_schema_json(),
                TAG_1,
        ...
        fn issuer_create_and_store_credential_def_works_for_null_config() {
            let (wallet_handle, wallet_config) = wallet::create_and_open_default_wallet(
                "issuer_create_and_store_credential_def_works_for_null_config",
            )
            .unwrap();
    ...
    mod issuer_create_credential_offer {
        ...
        fn issuer_create_credential_offer_works_for_unknown_cred_def_id() {
            ...
            let res = anoncreds::issuer_create_credential_offer(
                wallet_handle,
                "NcYxiDXkpYi6ov5FcYDi1e:3:CL:100",
            );
    ...
    mod prover_create_master_secret {
        ...
        fn prover_create_master_secret_works_invalid_wallet_handle() {
            ...
            let res =
                anoncreds::prover_create_master_secret(invalid_wallet_handle, COMMON_MASTER_SECRET);
    ...
    mod prover_create_credential_req {
        ...
        fn prover_create_credential_req_works_for_invalid_credential_offer() {
            ...
            let res = anoncreds::prover_create_credential_req(
                wallet_handle,
                DID_MY1,
        ...
        fn prover_create_credential_req_works_for_credential_def_not_correspond_to_credential_offer(
            ...
            let (issuer1_gvt_credential_def, issuer1_gvt_credential_offer, _, _) =
                anoncreds::init_common_wallet();

            let wallet_handle =
                wallet::open_wallet(ANONCREDS_WALLET_CONFIG, WALLET_CREDENTIALS).unwrap();

            let mut issuer_create_credential_offer: serde_json::Value =
                serde_json::from_str(&issuer1_gvt_credential_offer).unwrap();

            issuer_create_credential_offer["key_correctness_proof"]["c"] =
                serde_json::Value::String("11111111".to_string());

            let other_credential_offer =
                serde_json::to_string(&issuer_create_credential_offer).unwrap();
    ...
    mod prover_store_credential {
        ...
        fn prover_store_credential_works_for_invalid_wallet_handle() {
            ...
            let (prover_wallet_handle, prover_wallet_config) =
                wallet::create_and_open_default_wallet(
                    "prover_store_credential_works_for_invalid_wallet_handle",
                )
                .unwrap();

            anoncreds::prover_create_master_secret(prover_wallet_handle, COMMON_MASTER_SECRET)
                .unwrap();

            let (credential_req, credential_req_meta) = anoncreds::prover_create_credential_req(
            ...
            let (credential_json, _, _) = anoncreds::issuer_create_credential(
                wallet_handle,
                &credential_offer,
                &credential_req,
                &anoncreds::gvt_credential_values_json(),
            ...
            let res = anoncreds::prover_store_credential(
                invalid_wallet_handle,
                CREDENTIAL1_ID,
                &credential_req_meta,
                &credential_json,
        ...
        fn prover_store_credential_works_for_invalid_credential_json() {
            ...
            let (_, cred_req_metadata) = anoncreds::prover_create_credential_req(
                wallet_handle,
                DID_MY1,
                &credential_offer,
                &credential_def_json,
    ...
    mod verifier_verify_proof_with_proof_req_restrictions {
        ...
        fn verifier_verify_proof_success_with_in_wql() {
            let mut proof_req: ProofRequestPayload =
                serde_json::from_str(&anoncreds::proof_request_restrictions()).unwrap();
