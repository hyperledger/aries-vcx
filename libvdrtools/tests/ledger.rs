...
use utils::{
    ...
    domain::{
        ...
        ledger::{constants, did::NymData, request::DEFAULT_LIBIDY_DID},
    },
    types::*,
    Setup,
};
...
mod high_cases {
    ...
    mod author_agreement_acceptance {
        ...
        fn indy_txn_author_agreement_requests_works() {
            ...
            let (taa_text, taa_version, taa_digest, ratification_ts) = ledger::taa::gen_taa_data();
        ...
        fn indy_acceptance_mechanism_requests_works() {
            ...
            let (aml, _, aml_version, aml_context) = ledger::taa::gen_aml_data();
        ...
        fn indy_txn_author_agreement_requests_works_for_set_retirement_ts() {
            ...
            let txn_author_agreement_response = ledger::taa::send_taa(
                setup.pool_handle,
                setup.wallet_handle,
                &setup.did,
                &taa_text,
        ...
        fn indy_txn_author_agreement_requests_works_for_missed_ratification_ts() {
            ...
            let (taa_text, taa_version, _, _) = ledger::taa::gen_taa_data();
    ...
    mod in_memory_pool {
        ...
        #[test]
        #[cfg(feature = "local_nodes_pool")]
        fn indy_nym_requests_works_for_in_memory_pool() {
            ...
            let nym_request =
                ledger::build_nym_request(&truste_did, &my_did, Some(&my_verkey), None, None)
                    .unwrap();
            let nym_resp = ledger::sign_and_submit_request(
                setup.pool_handle,
                setup.wallet_handle,
            ...
            let get_nym_request = ledger::build_get_nym_request(None, &my_did).unwrap();
