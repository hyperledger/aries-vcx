...
pub const ISSUER_DID_V1: &'static str = "did:sov:NcYxiDXkpYi6ov5FcYDi1e";
...
pub const IDENTIFIER_V1: &'static str = "did:sov:Th7MpTaRZVRYnPiabds81Y";
...
pub const DEST_V1: &'static str = "did:sov:FYmoFw55GeQH7SRFa37dkx1d2dZ3zUF8ckg7wmL7ofN4";
