...
pub const ISSUER_DID_V1: &'static str = "did:indy:NcYxiDXkpYi6ov5FcYDi1e";
...
pub const DID_V1: &'static str = "did:indy:CnEDk9HrMnmiHXEV1WFgbVCRteYnPqsJwrTdcZaNhFVW";
pub const DID_MY1: &'static str = "VsKV7grR1BUE29mG2Fm2kX";
pub const DID_MY1_V1: &'static str = "did:indy:VsKV7grR1BUE29mG2Fm2kX";
...
pub const DEST_V1: &'static str = "did:indy:FYmoFw55GeQH7SRFa37dkx1d2dZ3zUF8ckg7wmL7ofN4";
...
pub const SCHEMA_DATA: &'static str = r#"{"id":"1", "name":"gvt","version":"1.0","attrNames":["name"],"ver":"1.0"}"#;
...
pub const DEFAULT_METHOD_NAME: &'static str = "indy";
pub const DEFAULT_PREFIX: &'static str = "did:indy:";
