...
type IndyPaymentCallback =
    extern "C" fn(command_handle_: CommandHandle, err: i32, payment_address: *const c_char) -> i32;

type ParsePaymentSourcesCallback = extern "C" fn(
...
pub mod mock_method {
    ...
    pub fn init() {
        CREATE_PAYMENT_METHOD_INIT.call_once(|| {
            ...
            unsafe {
                payments_sys::indy_register_payment_method(
                    cmd_handle,
    ...
    pub mod parse_get_payment_sources_response {
        ...
        pub extern "C" fn handle(
            ...
            cb: Option<ParsePaymentSourcesCallback>,
        ) -> i32 {
            let cb = cb.unwrap_or_else(|| panic!("Null passed as callback!"));
...
pub fn build_get_payment_sources_request(
    ...
    payments::build_get_payment_sources_request(wallet_handle, submitter_did, payment_address)
        .wait()
}
...
pub fn build_get_payment_sources_with_from_request(
    ...
    payments::build_get_payment_sources_with_from_request(
        wallet_handle,
        submitter_did,
        payment_address,
        from,
...
pub fn parse_response_with_fees(
    payment_method: &str,
    resp_json: &str,
) -> Result<String, IndyError> {
...
pub fn parse_get_payment_sources_with_from_response(
    payment_method: &str,
    resp_json: &str,
) -> Result<(String, Option<i64>), IndyError> {
...
pub fn prepare_extra_with_acceptance_data(
    ...
    payments::prepare_extra_with_acceptance_data(
        extra,
        text,
        version,
        taa_digest,
...
pub fn build_verify_payment_req(
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    receipt: &str,
) -> Result<(String, String), IndyError> {
...
pub fn parse_verify_payment_response(
    payment_method: &str,
    resp_json: &str,
) -> Result<String, IndyError> {
