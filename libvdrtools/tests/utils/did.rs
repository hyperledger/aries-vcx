...
pub fn create_store_and_publish_did(
...
pub fn create_store_predefined_trustee_did(
    wallet_handle: WalletHandle,
    method_name: Option<&str>,
) -> Result<(String, String), IndyError> {
    let my_did_json =
...
pub fn create_store_predefined_trustee_did_from_staging(
    ...
    let my_did_json =
        json!({"method_name": method_name, "seed": crate::utils::constants::TRUSTEE_SEED_2})
            .to_string();
    create_my_did(wallet_handle, &my_did_json)
}

pub fn create_store_and_publish_my_did_from_trustee(
    wallet_handle: WalletHandle,
    pool_handle: PoolHandle,
) -> Result<(String, String), IndyError> {
...
pub fn create_store_and_publish_my_did_from_trustee_v1(
    wallet_handle: WalletHandle,
    pool_handle: PoolHandle,
) -> Result<(String, String), IndyError> {
...
pub fn create_and_store_my_did_v1(
    wallet_handle: WalletHandle,
    seed: Option<&str>,
) -> Result<(String, String), IndyError> {
...
pub fn store_their_did_from_parts(
    wallet_handle: WalletHandle,
    their_did: &str,
    their_verkey: &str,
) -> Result<(), IndyError> {
...
pub fn replace_keys(
    ...
    let verkey = did::replace_keys_start(wallet_handle, did, "{}")
        .wait()
        .unwrap();
