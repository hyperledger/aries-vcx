...
use super::super::super::super::proto::cheqdid::cheqdnode::cheqd::v1::MsgCreateDidPayload as ProtoMsgCreateDidPayload;
use super::super::super::super::CheqdProtoBase;
use super::VerificationMethod;
use super::Service;

#[derive(Eq, PartialEq, Clone, Debug, Serialize, Deserialize)]
pub struct MsgCreateDidPayload {
...
impl CheqdProtoBase for MsgCreateDidPayload {
    type Proto = ProtoMsgCreateDidPayload;
...
#[cfg(test)]
mod test {
    use super::{MsgCreateDidPayload, VerificationMethod, Service};
    use super::super::super::super::super::CheqdProtoBase;
    use std::collections::HashMap;

    #[test]
    fn test_msg_create_did_payload() {
