...
use crate::{
    domain::anoncreds::{
        ...
        revocation_registry_definition::{rev_reg_defs_map_to_rev_reg_defs_v1_map, RevocationRegistryDefinitions},
...
impl VerifierController {
    ...
    pub fn verify_proof(
        ...
        trace!(
            "verify_proof > proof_req {:?} proof {:?} schemas {:?} cred_defs {:?} rev_reg_defs {:?} rev_regs {:?}",
            proof_req,
            proof,
            schemas,
            cred_defs,
