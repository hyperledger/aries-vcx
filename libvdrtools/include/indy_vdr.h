...
extern indy_error_t vdr_resolve_did_with_cache(indy_handle_t command_handle,
                                     indy_handle_t handle,
                                     const char *  fqdid,
...
extern indy_error_t vdr_resolve_schema_with_cache(indy_handle_t command_handle,
                                        indy_handle_t handle,
                                        const char *  fqschema,
                                        const char *  cache_options,
                                        void          (*cb)(indy_handle_t command_handle_, indy_error_t err, const char *const schema)
...
extern indy_error_t vdr_resolve_cred_def_with_cache(indy_handle_t command_handle,
                                          indy_handle_t handle,
                                          const char *  fqcreddef,
                                          const char *  cache_options,
                                          void          (*cb)(indy_handle_t command_handle_, indy_error_t err, const char *const cred_def)
...
extern indy_error_t vdr_submit_raw_txn(indy_handle_t      command_handle,
                                        indy_handle_t      handle,
                                        const char *       namespaces,
                                        const char *       signature_spec,
                                        const indy_u8_t*   txn_bytes_raw,
