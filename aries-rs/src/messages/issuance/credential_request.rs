...
use messages::attachment::{AttachmentId, Attachments};
use crate::messages::attachment::{Attachments, AttachmentId};
use crate::messages::a2a::MessageId;
use crate::vcx_shared::thread::Thread;
...
#[cfg(test)]
pub mod tests {
    use messages::issuance::credential_offer::tests::{thread, thread_id};

    use super::*;
    use crate::messages::issuance::credential_offer::tests::thread;
