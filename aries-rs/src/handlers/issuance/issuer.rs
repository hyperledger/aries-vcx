...
use crate::connection::{get_messages, send_message};
use crate::connection;
use crate::error::{VcxError, VcxErrorKind, VcxResult};
use crate::issuer_credential_utils::encode_attributes;
...
use crate::handlers::issuance::states::{InitialState, IssuerState};
...
pub mod test {
    ...
    use handlers::connection::tests::mock_connection;
    use messages::issuance::credential::tests::_credential;
    use messages::issuance::credential_offer::tests::_credential_offer;
    use messages::issuance::credential_proposal::tests::_credential_proposal;
    use messages::issuance::credential_request::tests::_credential_request;
    use messages::issuance::test::{_ack, _problem_report};
    use test::source_id;
