...
/// They link upstream to the [`MajorVersion`] impl enum they are part of.
/// The link downstream from the [`MajorVersion`] impl enum is done through the enum variant type binding.
/// 
...
/// 
/// This trait is typically implemented through deriving [`messages_macros::MessageType`] on the [`MajorVersion`] impl enum
...
/// 
/// E.g: `RoutingV1` would implement this, and its variants would look like `RoutingV1::V1_0`.
...
/// 
/// E.g: `Routing` would implement this, and its variants would look like `Routing::V1`.
