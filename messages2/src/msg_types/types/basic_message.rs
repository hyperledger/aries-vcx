...
pub enum BasicMessageProtocol {
    V1(BasicMessageProtocolV1),
}

#[derive(Copy, Clone, Debug, From, PartialEq, TransitiveFrom, MessageType)]
#[transitive(into(BasicMessageProtocol, Protocol))]
#[msg_type(major = 1)]
pub enum BasicMessageProtocolV1 {
    #[msg_type(minor = 0, roles = "Role::Receiver, Role::Sender")]
    V1_0(PhantomData<fn() -> BasicMessageProtocolV1_0>),
}

#[derive(Copy, Clone, Debug, AsRefStr, EnumString, PartialEq)]
#[strum(serialize_all = "kebab-case")]
pub enum BasicMessageProtocolV1_0 {
    Message,
}
...
mod tests {
    ...
    fn test_protocol_basic_message() {
        test_utils::test_serde(
            Protocol::from(BasicMessageProtocolV1::new_v1_0()),
    ...
    fn test_version_resolution_basic_message() {
        test_utils::test_msg_type_resolution(
            ...
            BasicMessageProtocolV1::new_v1_0(),
        )
    }
