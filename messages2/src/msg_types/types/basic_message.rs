...
mod tests {
    ...
    fn test_protocol_basic_message() {
        test_utils::test_protocol(PROTOCOL, BasicMessageV1::new_v1_0())
    }

    #[test]
    fn test_version_resolution_basic_message() {
        test_utils::test_protocol(VERSION_RESOLUTION_PROTOCOL, BasicMessageV1::new_v1_0())
    }

    #[test]
    #[should_panic]
    fn test_unsupported_version_basic_message() {
        test_utils::test_protocol(UNSUPPORTED_VERSION_PROTOCOL, BasicMessageV1::new_v1_0())
    }

    #[test]
    fn test_msg_type_message() {
        test_utils::test_msg_type(PROTOCOL, KIND_MESSAGE, BasicMessageV1::new_v1_0())
    }
}
