...
pub enum ReportProblemProtocol {
    V1(ReportProblemProtocolV1),
}

#[derive(Copy, Clone, Debug, From, PartialEq, TransitiveFrom, MessageType)]
#[transitive(into(ReportProblemProtocol, Protocol))]
#[msg_type(major = 1)]
...
pub enum ReportProblemProtocolV1_0 {
    ProblemReport,
}
...
mod tests {
    ...
    fn test_protocol_report_problem() {
        test_utils::test_serde(
            Protocol::from(ReportProblemProtocolV1::new_v1_0()),
    ...
    fn test_version_resolution_report_problem() {
        test_utils::test_msg_type_resolution(
            ...
            ReportProblemProtocolV1::new_v1_0(),
        )
    }
