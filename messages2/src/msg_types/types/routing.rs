...
pub enum RoutingProtocol {
    V1(RoutingProtocolV1),
}

#[derive(Copy, Clone, Debug, From, PartialEq, TransitiveFrom, MessageType)]
#[transitive(into(RoutingProtocol, Protocol))]
#[msg_type(major = 1)]
...
mod tests {
    ...
    fn test_protocol_routing() {
        test_utils::test_serde(
            Protocol::from(RoutingProtocolV1::new_v1_0()),
    ...
    fn test_version_resolution_routing() {
        test_utils::test_msg_type_resolution("https://didcomm.org/routing/1.255", RoutingProtocolV1::new_v1_0())
    }
