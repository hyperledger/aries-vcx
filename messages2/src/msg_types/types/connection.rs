...
pub enum ConnectionProtocol {
    V1(ConnectionProtocolV1),
}

#[derive(Copy, Clone, Debug, From, TryInto, PartialEq, TransitiveFrom, MessageType)]
#[transitive(into(ConnectionProtocol, Protocol))]
#[msg_type(major = 1)]
pub enum ConnectionProtocolV1 {
    #[msg_type(minor = 0, roles = "Role::Inviter, Role::Invitee")]
    V1_0(PhantomData<fn() -> ConnectionProtocolV1_0>),
}

#[derive(Copy, Clone, Debug, AsRefStr, EnumString, PartialEq)]
#[strum(serialize_all = "snake_case")]
pub enum ConnectionProtocolV1_0 {
    Invitation,
    Request,
    Response,
    ProblemReport,
...
mod tests {
    ...
    fn test_protocol_connections() {
        test_utils::test_serde(
            Protocol::from(ConnectionProtocolV1::new_v1_0()),
