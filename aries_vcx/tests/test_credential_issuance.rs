...
use crate::utils::scenarios::{
    ...
    accept_credential_proposal, accept_offer, attr_names, create_credential_proposal, create_holder_from_proposal,
    create_issuer_from_proposal, decline_offer, exchange_proof, send_credential,
};
