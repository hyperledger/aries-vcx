...
mod dbtests {
    ...
    use aries_vcx::libindy::wallet::WalletConfigBuilder;
    use aries_vcx::libindy::wallet::{close_wallet, create_wallet_with_master_secret, open_wallet, wallet_configure_issuer, WalletConfig};
