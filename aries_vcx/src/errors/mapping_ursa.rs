...
impl From<UrsaCryptoError> for AriesVcxError {
    fn from(err: UrsaCryptoError) -> Self {
        match err.kind() {
            UrsaCryptoErrorKind::InvalidState => AriesVcxError::from_msg(AriesVcxErrorKind::InvalidState, err),
            UrsaCryptoErrorKind::InvalidStructure => AriesVcxError::from_msg(AriesVcxErrorKind::InvalidInput, err),
            UrsaCryptoErrorKind::InvalidParam(_) => AriesVcxError::from_msg(AriesVcxErrorKind::InvalidInput, err),
            UrsaCryptoErrorKind::IOError => AriesVcxError::from_msg(AriesVcxErrorKind::IOError, err),
            UrsaCryptoErrorKind::ProofRejected => AriesVcxError::from_msg(AriesVcxErrorKind::InvalidState, err),
            ...
            UrsaCryptoErrorKind::CredentialRevoked => AriesVcxError::from_msg(AriesVcxErrorKind::InvalidState, err),
        }
    }
}
