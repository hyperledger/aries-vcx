...
impl RevocationNotificationSender {
    pub fn build() -> Self {
        Self { sender_sm: RevocationNotificationSenderSM::create() }
    }

    pub async fn send_revocation_notification(self, config: SenderConfig, send_message: SendClosure) -> VcxResult<Self> {
