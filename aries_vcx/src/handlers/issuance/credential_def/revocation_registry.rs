...
impl RevocationRegistry {
    pub fn create(issuer_did: &str, cred_def_id: &str, tails_dir: &str, max_creds: u32, tag: u32) -> VcxResult<RevocationRegistry> {
    ...
    pub fn publish_rev_reg_def(&mut self, issuer_did: &str, tails_url: &str) -> VcxResult<()> {
    ...
    pub fn publish_rev_reg_delta(&mut self, issuer_did: &str) -> VcxResult<()> {
