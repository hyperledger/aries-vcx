...
pub struct RevocationRegistry {
    ...
    pub(in crate::xyz) rev_reg_def: RevocationRegistryDefinition,
    pub(in crate::xyz) rev_reg_entry: String,
    pub(in crate::xyz) tails_dir: String,
    pub(in crate::xyz) max_creds: u32,
    pub(in crate::xyz) tag: u32,
