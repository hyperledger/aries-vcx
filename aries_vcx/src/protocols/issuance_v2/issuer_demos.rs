...
//             .issuer_create_and_store_revoc_reg("issuer_did", "cred_def_id", tails_dir, 100,
// "tag")             .await
//             .unwrap();
...
//         let issuer =
//             IssuerV2::<ProposalReceived<AnoncredsIssuerCredentialIssuanceFormat>>::from_proposal(
//                 proposal,
//             );
...
//             anoncreds: &anoncreds,
//             credential_attributes: HashMap::from([(String::from("dob"),
// String::from("19742110"))]),             revocation_info:
// Some(AnoncredsCreateCredentialRevocationInfoInput {                 registry_id: rev_reg_id,
...
//         let issuer =
//             IssuerV2::<ProposalReceived<LdProofIssuerCredentialIssuanceFormat>>::from_proposal(
//                 proposal,
//             );
...
//             .prepare_credential(&(), Some(4), Some(true), None)
//             .await
//             .unwrap();
...
//         ) -> IssuerV2<CredentialPrepared<LdProofIssuerCredentialIssuanceFormat>> { // receive
//           request message let request = RequestCredentialV2;
