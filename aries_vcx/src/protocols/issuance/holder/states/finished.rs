...
impl FinishedHolderState {
    ...
    pub fn get_attachment(&self) -> VcxResult<String> {
        let credential = self
            .credential
            .as_ref()
            .ok_or(ErrorAriesVcx::from_msg(ErrorKindAriesVcx::InvalidState, "No credential found"))?;
    ...
    pub fn get_tails_location(&self) -> VcxResult<String> {
        ...
        let rev_reg_def_json = self.rev_reg_def_json.as_ref().ok_or(ErrorAriesVcx::from_msg(
        ...
        let value = rev_reg_def["value"].as_object().ok_or(ErrorAriesVcx::from_msg(
            ErrorKindAriesVcx::InvalidJson,
            format!(
        ...
        let tails_location = value["tailsLocation"].as_str().ok_or(ErrorAriesVcx::from_msg(
            ErrorKindAriesVcx::InvalidJson,
            format!(
    ...
    pub fn get_tails_hash(&self) -> VcxResult<String> {
        ...
        let tails_hash = value["tailsHash"].as_str().ok_or(ErrorAriesVcx::from_msg(
            ErrorKindAriesVcx::InvalidJson,
            format!(
                "The field 'tailsLocation' not found on rev_reg_def_json: {:?}",
                self.rev_reg_def_json
    ...
    pub fn get_rev_reg_id(&self) -> VcxResult<String> {
        ...
        let rev_reg_def_id = rev_reg_def["id"].as_str().ok_or(ErrorAriesVcx::from_msg(
            ErrorKindAriesVcx::InvalidJson,
    ...
    pub fn get_cred_id(&self) -> VcxResult<String> {
        self.cred_id.clone().ok_or(ErrorAriesVcx::from_msg(
            ErrorKindAriesVcx::InvalidJson,
