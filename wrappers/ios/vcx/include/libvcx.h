...
vcx_error_t vcx_credential_revokable(vcx_command_handle_t handle, vcx_credential_handle_t credential_handle, void (*cb)(vcx_command_handle_t command_handle, vcx_error_t err, vcx_bool_t revokable));
