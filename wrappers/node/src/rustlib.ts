...
export interface IFFIEntryPoint {
  ...
  vcx_disclosed_proof_get_attributes: (commandId: number, handle: number, cb: any) => number,
...
export const FFIConfiguration: { [ Key in keyof IFFIEntryPoint ]: any } = {
  ...
  vcx_disclosed_proof_get_attributes: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_PROOF_HANDLE, FFI_CALLBACK_PTR]],
