...
export interface IFFIEntryPoint {
  ...
  // wallet
  vcx_create_wallet: (commandId: number, config: string, cb: any) => number,
  vcx_configure_issuer_wallet: (commandId: number, seed: string, cb: any) => number,
  vcx_open_wallet: (commandId: number, cb: any) => number,
  vcx_open_main_wallet: (commandId: number, config: string, cb: any) => number,
  vcx_close_main_wallet: (commandId: number, walletHandle: number, cb: any) => number,
  ...
  vcx_v2_issuer_credential_update_state: (commandId: number, handle: number, connHandle: number, cb: any) => number,
  ...
  vcx_issuer_credential_get_rev_reg_id: (commandId: number, credentialHandle: number, cb: any) =>
   number,
  ...
  vcx_v2_proof_update_state: (commandId: number, handle: number, connHandle: number, cb: any) => number,
  ...
  vcx_v2_disclosed_proof_update_state: (commandId: number, handle: number, connHandle: number, cb: any) => number,
  ...
  vcx_disclosed_proof_get_proof_request_attachment: (commandId: number, handle: number, cb: any) => number,
  ...
  vcx_v2_credential_update_state: (commandId: number, handle: number, connHandle: number, cb: any) => number,
  ...
  vcx_credentialdef_rotate_rev_reg_def: (commandId: number, handle: number, details: string, cb: any) => string,
...
export const FFIConfiguration: { [ Key in keyof IFFIEntryPoint ]: any } = {
  ...
  vcx_close_main_wallet: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_UNSIGNED_INT, FFI_CALLBACK_PTR]],
  ...
  vcx_v2_issuer_credential_update_state: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CREDENTIAL_HANDLE,
  ...
  vcx_issuer_credential_get_rev_reg_id: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CREDENTIAL_HANDLE, FFI_CALLBACK_PTR]],
  ...
  vcx_v2_proof_update_state: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_PROOF_HANDLE, FFI_CONNECTION_HANDLE,
    FFI_CALLBACK_PTR]],
  ...
  vcx_v2_disclosed_proof_update_state: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_PROOF_HANDLE, FFI_CONNECTION_HANDLE,
    FFI_CALLBACK_PTR]],
  ...
  vcx_disclosed_proof_get_proof_request_attachment: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_PROOF_HANDLE, FFI_CALLBACK_PTR]],
  ...
  vcx_credential_get_attachment: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CONNECTION_HANDLE,
    FFI_CALLBACK_PTR]],
  vcx_credential_get_tails_location: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CONNECTION_HANDLE,
    FFI_CALLBACK_PTR]],
  vcx_credential_get_tails_hash: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CONNECTION_HANDLE,
    FFI_CALLBACK_PTR]],
  vcx_credential_get_rev_reg_id: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CONNECTION_HANDLE,
    FFI_CALLBACK_PTR]],
  ...
  vcx_credentialdef_rotate_rev_reg_def: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CREDENTIALDEF_HANDLE, FFI_STRING_DATA,
    FFI_CALLBACK_PTR]],
  vcx_credentialdef_publish_revocations: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CREDENTIAL_HANDLE,FFI_CALLBACK_PTR]],
  vcx_credentialdef_get_tails_hash: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CREDENTIAL_HANDLE,FFI_CALLBACK_PTR]],
  vcx_credentialdef_get_rev_reg_id: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CREDENTIAL_HANDLE,FFI_CALLBACK_PTR]],
