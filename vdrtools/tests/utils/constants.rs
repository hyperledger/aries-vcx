...
pub const DID_V1: &'static str = "did:indy:sovrin:builder:CnEDk9HrMnmiHXEV1WFgbVCRteYnPqsJwrTdcZaNhFVW";
...
pub const DEST_V1: &'static str = "did:indy:sovrin:builder:FYmoFw55GeQH7SRFa37dkx1d2dZ3zUF8ckg7wmL7ofN4";
