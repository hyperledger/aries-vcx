// The byte arrays come directly from the agency team's documentation
...
pub const UPDATE_PROFILE_RESPONSE: &'static [u8; 57] = &[129, 167, 98, 117, 110, 100, 108, 101, 100, 145, 220, 0, 37, 208, 129, 208, 165, 64, 116, 121, 112, 101, 208, 130, 208, 164, 110, 97, 109, 101, 208, 175, 67, 79, 78, 70, 73, 71, 83, 95, 85, 80, 68, 65, 84, 69, 68, 208, 163, 118, 101, 114, 208, 163, 49, 46, 48];
...
#[cfg(test)]
pub const MY3_SEED: &str = "00000000000000000000000000000My3";
#[cfg(test)]
pub const MY4_SEED: &str = "00000000000000000000000000000My4";
